...
# Create output object
    ...
    $OutputObject | Add-Member -type NoteProperty -name PublicIPAddress -value $IPAddress
    $OutputObject | Add-Member -type NoteProperty -name RemoteHost -value $RemoteHost
    $OutputObject | Add-Member -type NoteProperty -name InternalIPAddress -value $InternalIPAddress
    ...
    $OutputObject | Add-Member -type NoteProperty -name DHCPENabled -value $DHCPENabled
    $OutputObject | Add-Member -type NoteProperty -name DHCPServer -value $DHCPServer
    $OutputObject | Add-Member -type NoteProperty -name DNSServer -value $DNSServer
    $OutputObject | Add-Member -type NoteProperty -name MACAddress -value $MACAddress
